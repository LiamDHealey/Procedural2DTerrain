...
#include "ProcedualTerrainToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UProcedualTerrainToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ProcedualTerrainToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UProcedualTerrainToolEditorMode();
	virtual ~UProcedualTerrainToolEditorMode();
