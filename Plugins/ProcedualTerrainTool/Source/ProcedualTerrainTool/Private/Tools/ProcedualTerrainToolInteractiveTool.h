...
#include "ProcedualTerrainToolInteractiveTool.generated.h"


/**
 * Builder for UProcedualTerrainToolInteractiveTool
 */
UCLASS()
class PROCEDUALTERRAINTOOL_API UProcedualTerrainToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UProcedualTerrainToolInteractiveTool
 */
UCLASS(Transient)
class PROCEDUALTERRAINTOOL_API UProcedualTerrainToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UProcedualTerrainToolInteractiveToolProperties();
...
/**
 * UProcedualTerrainToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PROCEDUALTERRAINTOOL_API UProcedualTerrainToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UProcedualTerrainToolInteractiveToolProperties> Properties;
