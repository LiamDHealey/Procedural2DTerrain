...
#include "ProcedualTerrainToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UProcedualTerrainToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UProcedualTerrainToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UProcedualTerrainToolInteractiveTool* NewTool = NewObject<UProcedualTerrainToolInteractiveTool>(SceneState.ToolManager);
...
UProcedualTerrainToolInteractiveToolProperties::UProcedualTerrainToolInteractiveToolProperties()
{
...
void UProcedualTerrainToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UProcedualTerrainToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UProcedualTerrainToolInteractiveToolProperties>(this, "Measurement");
...
void UProcedualTerrainToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UProcedualTerrainToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UProcedualTerrainToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UProcedualTerrainToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UProcedualTerrainToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UProcedualTerrainToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UProcedualTerrainToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UProcedualTerrainToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UProcedualTerrainToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
